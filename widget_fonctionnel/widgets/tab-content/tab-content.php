						...
						<?php foreach ($settings['list'] as $index => $item) { 
							...
							<li class="tab<?= $valueIncRender ?>">
								<label for="tab<?= $valueIncRender ?>" class="image-icon">
									...
									<p <?php $this->print_render_attribute_string($repeater_setting_key_title_tab) ?>><?php $title_tab = $settings['list'][$index]['TitleTab']; echo $title_tab ?> </p>
								</label>
							</li>
								...
								<div class="tab-container_icon">
									...
									<?php if ($item['GalleryIcon']) {
										foreach ($item['GalleryIcon'] as $image) { 
											...
											<div class="tab-container_icon_image"><img src="<?php echo $image['url'] ?>" alt="<?php echo $alt ?>" class="icon" />
