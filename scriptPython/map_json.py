...
# Le JSON avec les correspondances des départements
json_data = '''
[
  {
    "num_dep": "01",
...
# Le fichier SVG avec les identifiants à remplacer
svg_data = '''
...
for obj in json_obj:
    num_dep = obj['num_dep']
    dep_name = obj['dep_name']
    
    # Utiliser une expression régulière pour trouver les identifiants des chemins (paths)
    pattern = r'id="dep_' + str(num_dep) + r'"'
    replacement = r'id="' + dep_name + r'"'
