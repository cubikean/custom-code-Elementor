...
def compress_video(input_path, output_path, target_bitrate):
    ...
    compressed_video = video.resize(width=video.w // 1)  # Reduce the video size
...
# Example usage
input_path = "C:/Users/Beekom/Desktop/dev/DEV/scriptPython/videoInput/video-fb.mp4"
output_path = "C:/Users/Beekom/Desktop/dev/DEV/scriptPython/videoOutput/video-fb.mp4"
