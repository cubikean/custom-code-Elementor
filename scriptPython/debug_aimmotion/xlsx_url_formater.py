    ...
    for row in feuille.iter_rows(min_col=colonne_index, max_col=colonne_index, values_only=False):
        ...
        if cellule.value and isinstance(cellule.value, str) and "http" in cellule.value:
            ...
            for url in urls:
                ...
                nouvelles_urls.append(f"https://aimmotion.beekom.fr/wp-content/uploads/2024/03/{nom_fichier}.pdf")
...
input_file_path = "./SONOMAX_2902_Import_first.xlsx"
output_file_path = "./SONOMAX_2902_Import_first_updated.xlsx"
colonne_index = 18
